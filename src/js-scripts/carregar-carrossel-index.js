...
import { carregarAncorasCarrossel } from "../js-funcoes/funcao-carrossel-livro-home.js"
import { carregarCards } from "../js-funcoes/funcao-card-livro-home.js"

window.addEventListener("DOMContentLoaded", () => {

    let vetorTop8 = []

    vetorTop8 = JSON.parse(localStorage.getItem("top 8 livros"))
