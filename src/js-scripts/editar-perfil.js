...
const getleitor = () => {
    ...
    const leitorAtual = vetorLeitores.find((leitor) => leitor.usuario === localStorage.getItem("leitor logado"))
...
const confirmarEditar = document.getElementById("editar-dados-pessoais-confirmar");
...
const confirmarEditarEndereco = document.getElementById("editar-endereco-confirmar");
...
const editarFavoritosConfirmar = document.getElementById("editar-favoritos-confirmar");
...
confirmarEditarSenha.addEventListener("click", function (evento) {
    ...
    if (novaSenha.value === confirmarNovaSenha.value) {
        ...
        alert("As senhas devem ser digitadas iguais")
    )
